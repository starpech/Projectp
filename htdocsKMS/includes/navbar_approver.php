...
<!-- login แล้ว -->
    <ul class="navbar-nav mr-auto">
      ...
      <a class="nav-link dropdown-toggle active" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">รายการขออนุมัติ</a>
      <div class="dropdown-menu " aria-labelledby="dropdownMenuLink">

        <a class="dropdown-item " href="req_order.php">อนุมัติรายการขอซื้อ1</a>
        
        <a class="dropdown-item" href="approve_page.php" >แสดงรายการอนุมัต1</a>
      </div>
    </div>
    </li>
<!--      <li class="nav-item">
      ...
      <li class="nav-item">
       <!-- <a class="nav-link" href="orderhistory.php"><?php echo $orderhistory?> </a> -->
        <a class="nav-link" href="/CRUD with PDF PHP/crud_datatable_tcpdf/index.php">แก้ไขรายการขอซื้อ</a>
      </li>
    </ul>
