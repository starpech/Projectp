<?php
/**
 * @filesource modules/documentation/models/admin/category.php
 *
    ...
    public function submit(Request $request)
    {
        ...
        if ($request->initSession() && $request->isSafe() && $login = Login::adminAccess()) {
            if (Login::notDemoMode($login)) {
                ...
                $index = \Index\Adminmodule\Model::getModuleWithConfig('documentation', $request->post('module_id')->toInt());
                // สามารถตั้งค่าได้
