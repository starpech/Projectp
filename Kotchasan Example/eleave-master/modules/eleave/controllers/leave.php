...
class Controller extends \Gcms\Controller
{
    ...
    public function render(Request $request)
    {
        ...
        // เลือกเมนู
        $this->menu = 'eleave';
        // ใหม่, เจ้าของ, อนุมัติได้
        if ($index && $login && ($index->id == 0 || $login['id'] == $index->member_id || Login::checkPermission($login, 'can_approve_eleave'))) {
            // แสดงผล
            ...
            // แสดงฟอร์ม
            $section->appendChild(createClass('Eleave\Leave\View')->render($index, $login));
            // คืนค่า HTML
