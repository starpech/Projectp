...
if (defined('ROOT_PATH')) {
    ...
    if (!$error) {
        ...
        if (!$error) {
            ...
            $sql = "INSERT INTO `".$_SESSION['prefix']."_user` (`id`, `username`, `salt`, `password`, `token`, `status`, `permission`, `name`) VALUES";
            $sql .= "(1, '".$username."', '".$salt1."', '".sha1($password.$salt1)."', NULL, 1, '', 'แอดมิน');";
            $conn->query($sql);
