    ...
    if (empty($_POST['username']) || empty($_POST['password'])) {
        ...
        if (!$error) {
            ...
            try {
                ...
                $content[] = '<li class="correct">อัปเดตข้อมูลผู้ดูแลระบบสำเร็จ</li>';
                // ตาราง edocument
                ...
                if (!isset($config['default_icon'])) {
                    $config['default_icon'] = $new_config['default_icon'];
                }
                if (!isset($config['csv_language'])) {
                    $config['csv_language'] = $new_config['csv_language'];
                }
