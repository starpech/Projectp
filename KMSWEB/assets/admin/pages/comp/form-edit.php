          ...
          <div class="card-body">
            <div class="form-row">
			  ...
			  <input type="text" class="form-control" id="comp_code" name="comp_code" value="<?php echo $row['comp_code']?>" hidden>
                  ...
                  <input type="text" class="form-control" id="comp_code" name="comp_code" value="<?php echo $row['comp_code']?>" disabled>
              </div>
              <div class="form-group col-md-8">
                  <label for="comp_name">ชื่อบริษัท</label>
                  <input type="text" class="form-control" id="comp_name" name="comp_name" value="<?php echo $row['comp_name']?>"disabled>
              </div>
              <div class="form-group col-md-2">
                  <label for="comp_nickname">ชื่อย่อบริษัท</label>
                  <input type="text" class="form-control" id="comp_nickname" name="comp_nickname" value="<?php echo $row['comp_nickname']?>"disabled>
              </div>
              <div class="form-group col-md-3">
                  <label for="comp_email">อีเมล</label>
                  <input type="email" class="form-control" id="comp_email" name="comp_email"  value="<?php echo $row['comp_email']?>"disabled>
              </div>

              <div class="form-group col-md-3">
                  <label for="comp_tel">โทรศัพท์</label>
                  <input type="text" class="form-control" id="comp_tel"  name="comp_tel" value="<?php echo $row['comp_tel']?>"disabled>
              </div>
			  <div class="form-group col-md-3">
                  <label for="comp_fax">แฟ๊กซ์</label>
                  <input type="text" class="form-control" id="comp_fax"  name="comp_fax" value="<?php echo $row['comp_fax']?>"disabled>
              </div>
              <div class="form-group col-md-3">
                  <label for="comp_type">สถานะ</label>
                  <select name="comp_type" id="comp_type" class="form-control"disabled>
                  <?php 
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="comp_addr" name="comp_addr"  rows="5"disabled> <?php echo $row['comp_addr']?></textarea>
            </div>
