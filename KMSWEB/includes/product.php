...
if($_GET['product_tag']==""){
  $sql = "SELECT * FROM `product` where flag='0'";
}else{
  $sql = "select * from product where flag='0' and `product_tag` =  '".$_GET['product_tag']."'  ";
}
          ...
          <!-- <div class="col-sm-4" style="padding: 20px;padding-left: 90px;"> -->
            <div class="card card-5 " data-toggle="modal" data-target="#myModal<?php echo $row["product_id"]; ?>">
              ...
              <div class="card-body">
                ...
                <a class="card-link fonts" style="color:green;margin-left: 100px"><?php echo number_format($row['product_price1'], 2) ?>฿</a>
              </div>
              <!-- /////////////////////  -->
              <p class="card-text">
