...
<!-- login แล้ว -->
    <ul class="navbar-nav mr-auto">
      ...
      <a class="nav-link dropdown-toggle active" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">รายการขอซื้อ</a>
      <div class="dropdown-menu " aria-labelledby="dropdownMenuLink">

        <a class="dropdown-item " href="req_order.php">สร้างรายการขอซื้อ</a>
        
        <a class="dropdown-item" href="approve_page.php" >แสดงรายการขอซื้อ</a>
      </div>
    </div>
    </li>
<!--      <li class="nav-item">
