...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 06, 2020 at 04:40 PM
...
(13, '09', 'hjggjhgfg', 'XXX', ' 7908908', '0264261910', '0988999', 'hjgjhgjh@jhkhl', 'ผู้ซื้อ', '2020-07-09 00:00:00', '1'),
...
(24, '5f291b76e84d6', '1', 2, 'Bags'),
(25, '5f291b95b998b', 'ฟหก', 0, 'Bottles');
...
CREATE TABLE `tbl_unit` (
  ...
  `unit_name` varchar(250) CHARACTER SET latin1 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `tbl_order_items`
  MODIFY `order_items_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
