...
try{
    ...
    $sql="select * from members where mem_status = 'approver' and comp_code = $comp_code";
	//echo $sql;
    ...
    if(mysqli_num_rows($res)>0)
    {
        ...
        // Content
        $mail->isHTML(true);
        $mail->Subject = 'แจ้งเตือน!!!มีรายการขอซื้อจากระบบ KMSWeb เพื่อรอการอนุมัติ';
        $mail->Body = 'เรียน คุณ &nbsp; <h4>$mem_name</h4><br>
        มีรายการขอซื้อเพื่อรอการอนุมัติจากท่าน &nbsp; <br>ขอแสดงความนับถือ <br><br> จดหมายนี้ออกจากระบบอัตโนมัติ
        เจ้าหน้าที่ดูแลระบบ&nbsp; KMSWeb";<h1>This will be sent to all</h1>';
