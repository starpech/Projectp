...
try{
    ...
    if(mysqli_num_rows($res)>0)
    {
        ...
        // Content
        $mail->isHTML(true);
        $mail->Subject = 'รายการแจ้งเตือน มีรายการขอซื้อที่ได้รับการอนุมัตแล้ว';
        $mail->Body = 'เรียน คุณ &nbsp; <h4>$mem_name</h4><br>
        มีรายการขอซื้อที่ได้รับการอนุมัติแล้ว และสร้างใบสั่งซื้อในลำดับต่อไป &nbsp; <br>ขอแสดงความนับถือ <br><br> จดหมายนี้ออกจากระบบอัตโนมัติ
        &nbsp; KMSWeb';
