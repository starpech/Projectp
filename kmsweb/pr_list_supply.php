...
function dbPrMain(){
  ...
  FROM `pr_main` as p
  where flag_delete = 0 and p.pr_SupplierID = '{$_SESSION['comp_code']}'
  ";
  $find_date = isset($_GET['findDate'])?$_GET['findDate']:'';
  if($find_date){

   // $query .= " and DATE_FORMAT(pr_date,'%Y-%m-%d') = '{$find_date}' ";
  ...
  <div class="container-fluid" align="center">
   ...
   <div class="table-responsive">
    ...
    <thead width="100%" class="thead-light">
                <th ><h5 align="center">เลขที่ใบสั่งซื้อ</h5></th>
       <th ><h5 align="center">วันที่สั่งซื้อ</h5></th>
       <th ><h5 align="center">บริษัทที่จำหน่าย</h5></th>
            ...
            <tbody>
             ...
             foreach($dataPrMain as $row ){
              ...
              if($row[5]){
                ...
                $btnApproved = " <a href='pr_approved.php?id=".$row[0]."' class='btn btn-primary btn-sm' > อนุมัติ </a>
                ";
              }
...
$('#find').click(()=>{
  ...
  window.location.href="pr_list.php?findDate="+find_date;
});
/*
$('#printPDF').click(()=>{
  var find_date=$('#findDate').val();
...
$('#find_all').click(()=>{
  window.location.href="pr_list.php";
});
