...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark fixed-top">
  <a href="index.php"> <img src="assets\image\LOGOKMS.PNG" alt="KMS LOGO" width="80" height="40"> </a>
  ...
  <div class="collapse navbar-collapse" id="navbarColor01">
    <?php if (isset($_SESSION["mem_id"])) { ?>
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <!--
      <li class="nav-item">
        <a class="nav-link" href="po_detail.php"><?php echo $po_detail ?> </a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="upload_doc.php"><?php echo $upload_doc ?> </a>
      </li>     
    -->
