        ...
        <form role="form" action="insert.php" method="post"enctype="multipart/form-data"id="formRegister">
          <div class="card-body">
            ...
            <div class="form-group col-md-12"> <label style="color:red" for="product_detail"> ราคาขายโรงงาน </label> </div> 
              ...
              <div class="form-group col-md-2"> <label for="product_detail"> Product Price 1 <span style="color:red">(BP)</span> </label>
              ...
              <div class="form-group col-md-2"> <label for="product_detail"> Product Price 2 <span style="color:red">(TK)</span></label>
                <div class="input-group-prepend">
              ...
              <div class="form-group col-md-2"> <label for="product_detail"> Product Price 3 <span style="color:red">(PN)</span></label>
                <div class="input-group-prepend">
              ...
              <div class="form-group col-md-2"> <label for="product_detail"> Product Price 4 <span style="color:red">(NP)</span></label>
                <div class="input-group-prepend">
              ...
              <div class="form-group col-md-2"> <label for="product_detail"> Product Price 5 <span style="color:red">(WP)</span> </label>
                <div class="input-group-prepend">
            ...
            <div class="form-group col-md-2"> <label for="product_detail"> Product Cost 1 <span style="color:red">(BP)</span> </label>
                <div class="input-group-prepend">
              ...
              <div class="form-group col-md-2"> <label for="product_detail"> Product Cost 2 <span style="color:red">(TK)</span></label>
                <div class="input-group-prepend">
              ...
              <div class="form-group col-md-2"> <label for="product_detail"> Product Cost 3 <span style="color:red">(PN)</span></label>
                <div class="input-group-prepend">
              ...
              <div class="form-group col-md-2"> <label for="product_detail"> Product Cost 4 <span style="color:red">(NP)</span></label>
                <div class="input-group-prepend">
              ...
              <div class="form-group col-md-2"> <label for="product_detail"> Product Cost 5 <span style="color:red">(WP)</span> </label>
                <div class="input-group-prepend">
